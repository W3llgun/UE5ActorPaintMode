...
#include "ActorPaintModeInteractiveTool.generated.h"


/**
 * Builder for UActorPaintModeInteractiveTool
 */
UCLASS()
class ACTORPAINTMODE_API UActorPaintModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UActorPaintModeInteractiveTool
 */
UCLASS(Transient)
class ACTORPAINTMODE_API UActorPaintModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UActorPaintModeInteractiveToolProperties();
...
/**
 * UActorPaintModeInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ACTORPAINTMODE_API UActorPaintModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UActorPaintModeInteractiveToolProperties> Properties;
