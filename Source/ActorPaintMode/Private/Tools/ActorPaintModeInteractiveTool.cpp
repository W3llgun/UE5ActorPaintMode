...
#include "ActorPaintModeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UActorPaintModeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UActorPaintModeInteractiveToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UActorPaintModeInteractiveTool* NewTool = NewObject<UActorPaintModeInteractiveTool>(SceneState.ToolManager);
...
UActorPaintModeInteractiveToolProperties::UActorPaintModeInteractiveToolProperties()
{
...
void UActorPaintModeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UActorPaintModeInteractiveTool::Setup()
{
	...
	Properties = NewObject<UActorPaintModeInteractiveToolProperties>(this, "Measurement");
...
void UActorPaintModeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
void UActorPaintModeInteractiveTool::OnTick(float DeltaTime)
{
	Super::OnTick(DeltaTime);
}


FInputRayHit UActorPaintModeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UActorPaintModeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UActorPaintModeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UActorPaintModeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UActorPaintModeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UActorPaintModeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UActorPaintModeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UActorPaintModeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
