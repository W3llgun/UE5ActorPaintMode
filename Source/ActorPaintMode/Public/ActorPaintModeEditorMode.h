...
#include "ActorPaintModeEditorMode.generated.h"
 ...
 */
UCLASS()
class UActorPaintModeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ActorPaintModeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;
	static FString BrushToolName;
	static FString BrushRawToolName;

	UActorPaintModeEditorMode();
	virtual ~UActorPaintModeEditorMode() override;
	...
	TSharedPtr<SWidgetPainter> Painter = nullptr;
};
